...
<div class="photo-card-container">
    <article class="photo-card">
        ...
        <div class="photo-card-overlay">
            <button class="expand-btn"><svg width="34" height="34" viewBox="0 0 34 34" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <a href="<?php the_permalink() ?>" class="eye-icon"><svg width="46" height="32" viewBox="0 0 46 32" fill="none" xmlns="http://www.w3.org/2000/svg">
